    ...
    Column(
            ...
            Row(
                ...
                Row(
                    ...
                    Column {
                        ...
                        Text(
                            text = if (state.useFrontCamera) "Using Front / Selfie Camera" else "Using Rear / Back Camera",
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(18.dp)) {
                ...
                Text(
                    text = "PushCount does not use the internet or external servers. Camera frames and pose tracking are processed exclusively on your device's chip. All workout logs stay in local storage.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(18.dp)) {
                ...
                Text(
                    text = "Permanently delete all stored workout sessions, streak records, and reset your preferences to default.",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
